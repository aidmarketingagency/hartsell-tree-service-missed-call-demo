...
(function () {
  ...
  function showTeaser() {
    ...
    d.style.cssText = 'position:fixed;right:20px;bottom:98px;z-index:999998;max-width:250px;background:#14161A;color:#F4F4F5;padding:13px 32px 13px 16px;border-radius:16px;border:1px solid rgba(23,179,166,.45);box-shadow:0 12px 28px rgba(0,0,0,.5);font:500 14px/1.45 -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;cursor:pointer;opacity:0;transform:translateY(10px);transition:opacity .5s ease,transform .5s ease;';
    ...
    arrow.style.cssText = 'position:absolute;bottom:-7px;right:26px;width:12px;height:12px;background:#14161A;border-right:1px solid rgba(23,179,166,.45);border-bottom:1px solid rgba(23,179,166,.45);transform:rotate(45deg);';
    d.appendChild(txt);
    d.appendChild(x);
    d.appendChild(arrow);
